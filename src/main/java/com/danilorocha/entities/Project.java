...
public class Project {
    ...
    private Project(Long id, String name, String description, Instant createDate, Instant updateDate) {
        this.id = id;
        this.name = name;
    ...
    public static Project newProject(Long id, String name, String description, Instant createDate, Instant updateDate) {
